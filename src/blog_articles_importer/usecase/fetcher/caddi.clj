(ns blog-articles-importer.usecase.fetcher.caddi
  (:require [blog-articles-importer.fetcher :as fetcher]
            [clojure.string :as s]
            [integrant.core :as ig]))

(def ^:private base-url "https://caddi.tech/feed")
...
(defrecord CaddiFetcher
           [options]
  fetcher/Fetcher
  (execute [_ company] (fetch* company)))

(defmethod ig/init-key :blog-articles-importer.usecase.fetcher/caddi [_ options]
  (map->CaddiFetcher options))